...
payload1= {"user_id":1, "payload_size":[128],"frequency":[1], "bandwidth":1000000,"app":["app1"], "ms_chain":["2,ms1-1-1,1-1"], "entry_point":["endpoint1"]}
...
response = requests.post(url="http://127.0.0.1:2333/run", headers={"Content-Type": "application/json"},data=pickle.dumps(payload1))
